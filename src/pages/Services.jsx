...
const Services = () => {
    return (
        <div className="flex flex-col lg:flex-row p-12 mt-16 lg:items-center gap-8 lg:justify-between ">
            <div className="flex flex-col text-lg gap-1">
                <span className="font-bold text-[#e95495]">SERVICES</span>
                <p className="text-xl font-bold flex flex-col">Our top <span>value categroies for you</span></p>
            </div>
